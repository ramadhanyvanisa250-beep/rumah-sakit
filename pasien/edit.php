...
if($_POST){
    ...
    if($stmt->execute([$nama, $alamat, $no_telepon, $jenis_kelamin, $tanggal_lahir, $id])){
...
<head>
    ...
    <title>Edit Pasien - Rumah Sakit Sehat</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-edit me-2"></i>Edit Pasien</h2>
                ...
                <form method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control" name="no_telepon" value="<?php echo $pasien['no_telepon']; ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="tanggal_lahir" value="<?php echo $pasien['tanggal_lahir']; ?>" required>
                        </div>
                    </div>
